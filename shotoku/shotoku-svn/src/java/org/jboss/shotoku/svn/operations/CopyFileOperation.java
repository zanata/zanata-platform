 ...
 */
public class CopyFileOperation extends ResourceOperation {
	private String destParentPath;
	private String destPath;
	private long lastRevision;
	
	public CopyFileOperation(String id, String path, String destParentPath,
			String destName, long lastRevision) {
		super(id, path, OpCode.COPY_FILE);
	...
	public void execute(PathsStack stack, long lastRevision) throws SVNException {
		...
		editor.addFile(destPath, path.substring(1), this.lastRevision);
		stack.addPath(destPath, true);
	}
	
	public void addModifiedPaths(SvnService service) {
		service.addDirectoryToModfied(id, destParentPath);
		service.addNodeToModfied(id, destPath);
	}
}
