 ...
 */
public class AddDirectoryOperation extends ResourceOperation {
	private String parentPath;
	
	public AddDirectoryOperation(String id, String parentPath, 
			String newName, String concatenatedPath) {
		super(id, concatenatedPath, OpCode.ADD_DIRECTORY);
