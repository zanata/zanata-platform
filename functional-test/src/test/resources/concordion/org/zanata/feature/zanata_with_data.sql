...
ALTER TABLE PUBLIC.ITERATIONGROUP_LOCALE ADD CONSTRAINT PUBLIC.CONSTRAINT_10 PRIMARY KEY(ITERATION_GROUP_ID, LOCALE_ID);
...
INSERT INTO PUBLIC.HPROJECT(ID, CREATIONDATE, LASTCHANGED, VERSIONNUM, SLUG, DESCRIPTION, HOMECONTENT, NAME, OVERRIDELOCALES, STATUS, RESTRICTEDBYROLES, DEFAULT_COPY_TRANS_OPTS_ID, DEFAULTPROJECTTYPE, SOURCEVIEWURL, SOURCECHECKOUTURL) VALUES
(1, TIMESTAMP '2013-06-24 13:49:53.481', TIMESTAMP '2013-06-24 13:49:53.481', 0, 'about-fedora', '', NULL, 'about fedora', FALSE, 'A', FALSE, NULL, 'Podir', '', '');
...
INSERT INTO PUBLIC.HPROJECTITERATION(ID, CREATIONDATE, LASTCHANGED, VERSIONNUM, SLUG, PARENTID, PROJECT_ID, OVERRIDELOCALES, STATUS, PROJECTTYPE, REQUIRETRANSLATIONREVIEW) VALUES
(1, TIMESTAMP '2013-06-24 13:50:02.329', TIMESTAMP '2013-08-06 09:51:01.287', 1, 'master', NULL, 1, FALSE, 'A', 'Podir', TRUE);
...
ALTER TABLE PUBLIC.TRANSMEMORY_METADATA ADD CONSTRAINT PUBLIC.PK_TRANSMEMORY_METADATA PRIMARY KEY(TRANS_MEMORY_ID, METADATA_TYPE);
