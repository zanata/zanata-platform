...
DROP TABLE IF EXISTS PUBLIC.TRANSMEMORY_METADATA CASCADE;      
DROP TABLE IF EXISTS PUBLIC.TRANSMEMORYUNIT_METADATA CASCADE;  
DROP TABLE IF EXISTS PUBLIC.TRANSMEMORYUNITVARIANT_METADATA CASCADE;           
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_7DB9ECCC_FAEF_4161_BFB2_85A4C4BE96BF START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_EC9A15B9_9726_4429_84EA_52688B8B7F91 START WITH 1 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_706F25FE_B1BA_4E11_9341_00C53A817296 START WITH 2 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A46D148E_26EC_4ECC_80ED_A60EAB754F21 START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_EA725082_6ECC_4D7E_BF87_903C38282725 START WITH 6 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_435770F8_300C_4DBA_BB72_232B96E46942 START WITH 6 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_C505BDE1_8BCD_4405_BD9A_7768172D6EAD START WITH 6 BELONGS_TO_TABLE;     
...
(3, TIMESTAMP '2013-08-04 13:51:29.119', TIMESTAMP '2013-08-04 13:52:20.832', 5, 1, TIMESTAMP '2013-08-04 13:00:00.0', 3089119, 3140827, 'HProjectIteration', 1, 'HTexFlowTarget', 1, 'UPDATE_TRANSLATION', 6, 146),
(4, TIMESTAMP '2013-08-04 13:52:21.113', TIMESTAMP '2013-08-04 13:52:21.113', 0, 1, TIMESTAMP '2013-08-04 13:00:00.0', 3141113, 3141113, 'HProjectIteration', 1, 'HDocument', 1, 'UPLOAD_TRANSLATION_DOCUMENT', 1, 479),
(5, TIMESTAMP '2013-08-06 09:50:36.528', TIMESTAMP '2013-08-06 09:52:26.687', 3, 1, TIMESTAMP '2013-08-06 09:00:00.0', 3036528, 3146675, 'HProjectIteration', 1, 'HTexFlowTarget', 26, 'UPDATE_TRANSLATION', 4, 98),
(6, TIMESTAMP '2013-08-06 09:51:11.749', TIMESTAMP '2013-08-06 09:52:27.028', 3, 1, TIMESTAMP '2013-08-06 09:00:00.0', 3071749, 3147010, 'HProjectIteration', 1, 'HTexFlowTarget', 26, 'REVIEWED_TRANSLATION', 4, 180),
(7, TIMESTAMP '2013-08-06 09:52:27.047', TIMESTAMP '2013-08-06 09:52:27.047', 0, 1, TIMESTAMP '2013-08-06 09:00:00.0', 3147047, 3147047, 'HProjectIteration', 1, 'HDocument', 1, 'UPLOAD_TRANSLATION_DOCUMENT', 1, 479);      
...
(1, TIMESTAMP '2013-08-02 13:52:20.188', TIMESTAMP '2013-08-06 09:52:26.263', 1, STRINGDECODE('PO-Revision-Date=2013-08-06 09\\:51+1000\nLast-Translator=Administrator <admin@example.com>\nLanguage-Team=Polish\nLanguage=pl\nX-Generator=Zanata 3.0.0-alpha-2-SNAPSHOT\nPlural-Forms=nplurals\\=3; plural\\=(n\\=\\=1 ? 0 \\: n%10>\\=2 && n%10<\\=4 && (n%100<10 || n%100>\\=20) ? 1 \\: 2)\n'), NULL, 1, 4);        
...
-- 5 +/- SELECT COUNT(*) FROM PUBLIC.HTEXTFLOWTARGETHISTORY;   
INSERT INTO PUBLIC.HTEXTFLOWTARGETHISTORY(ID, LASTCHANGED, STATE, TF_REVISION, VERSIONNUM, LAST_MODIFIED_BY_ID, TARGET_ID, TRANSLATED_BY_ID, REVIEWED_BY_ID) VALUES
(1, TIMESTAMP '2013-08-02 13:52:20.652', 0, 1, 1, NULL, 26, NULL, NULL),
(2, TIMESTAMP '2013-08-02 13:52:20.67', 0, 1, 1, NULL, 27, NULL, NULL),
(3, TIMESTAMP '2013-08-06 09:50:36.321', 2, 1, 2, 1, 26, 1, NULL),
(4, TIMESTAMP '2013-08-06 09:50:38.908', 2, 1, 2, 1, 27, 1, NULL),
(5, TIMESTAMP '2013-08-02 13:51:28.913', 2, 1, 1, 1, 1, 1, NULL);   
...
(26, TIMESTAMP '2013-08-02 13:52:20.652', TIMESTAMP '2013-08-06 09:51:11.731', 3, 3, 1, NULL, 1, 4, 26, 'You can read weblogs of many Fedora contributors at our official aggregator, <ulink url="http://planet.fedoraproject.org/" />.', NULL, NULL, NULL, NULL, NULL, 1, 1),
(27, TIMESTAMP '2013-08-02 13:52:20.67', TIMESTAMP '2013-08-06 09:51:43.562', 3, 4, 1, NULL, 1, 4, 27, 'JBoss EAP 6  allows you to package Hibernate 3.5 (or greater) persistence provider jars with the application. To direct the server to use only the Hibernate 3 libraries and to exclude the Hibernate 4 libraries, you need to set the <Pcode>jboss.as.jpa.providerModule</code> to <literal>hibernate3-bundled</literal> in the <filename>persistence.xml</filename> as follows: <programlisting language="XML"><![CDATA[<?xml version="1.0" encoding="UTF-8"?><persistence xmlns="http://java.sun.com/xml/ns/persistence" version="1.0">    <persistence-unit name="plannerdatasource_pu">        <description>Hibernate 3 Persistence Unit.</description>        <jta-data-source>java:jboss/datasources/PlannerDS</jta-data-source>        <properties>            <property name="hibernate.show_sql" value="false" />            <property name="jboss.as.jpa.providerModule" value="hibernate3-bundled" />        </properties>    </persistence-unit></persistence>]]>          </programlisting> The Java Persistence API (JPA) deployer will detect the presence of a persistence provider in the application and use the Hibernate 3 libraries.]}', NULL, NULL, NULL, NULL, NULL, 1, 1);
...
-- 5 +/- SELECT COUNT(*) FROM PUBLIC.HTEXTFLOWTARGETCONTENTHISTORY;            
INSERT INTO PUBLIC.HTEXTFLOWTARGETCONTENTHISTORY(ID, CONTENT, POS, TEXT_FLOW_TARGET_HISTORY_ID) VALUES
(1, '', 0, 1),
(2, '', 0, 2),
(3, 'You can read weblogs of many Fedora contributors at our official aggregator, <ulink url="http://planet.fedoraproject.org/" />.', 0, 3),
(4, 'JBoss EAP 6  allows you to package Hibernate 3.5 (or greater) persistence provider jars with the application. To direct the server to use only the Hibernate 3 libraries and to exclude the Hibernate 4 libraries, you need to set the <Pcode>jboss.as.jpa.providerModule</code> to <literal>hibernate3-bundled</literal> in the <filename>persistence.xml</filename> as follows: <programlisting language="XML"><![CDATA[<?xml version="1.0" encoding="UTF-8"?><persistence xmlns="http://java.sun.com/xml/ns/persistence" version="1.0">    <persistence-unit name="plannerdatasource_pu">        <description>Hibernate 3 Persistence Unit.</description>        <jta-data-source>java:jboss/datasources/PlannerDS</jta-data-source>        <properties>            <property name="hibernate.show_sql" value="false" />            <property name="jboss.as.jpa.providerModule" value="hibernate3-bundled" />        </properties>    </persistence-unit></persistence>]]>          </programlisting> The Java Persistence API (JPA) deployer will detect the presence of a persistence provider in the application and use the Hibernate 3 libraries.]}', 0, 4),
(5, 'Fedora is an open, innovative, forward looking operating system and platform, based on Linux, that is always free for anyone to use, modify and distribute, now and forever. It is developed by a large community of people who strive to provide and maintain the very best in free, open source software and standards. Fedora is part of the Fedora Project, sponsored by Red Hat, Inc.', 0, 5);          
...
(1, TIMESTAMP '2013-06-24 13:50:02.329', TIMESTAMP '2013-08-06 09:51:01.287', 1, 'master', NULL, 1, FALSE, 'A', 'Podir', FALSE, TRUE); 
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.HTEXTFLOWTARGETREVIEWCOMMENT;             
INSERT INTO PUBLIC.HTEXTFLOWTARGETREVIEWCOMMENT(ID, CREATIONDATE, LASTCHANGED, COMMENTER_ID, TARGET_ID, COMMENT, TARGETVERSION, VERSIONNUM) VALUES
(1, TIMESTAMP '2013-08-06 09:51:43.411', TIMESTAMP '2013-08-06 09:51:43.411', 1, 27, 'reject comment', 2, 0);               
...
CREATE CACHED TABLE PUBLIC.TRANSMEMORY(
    DESCRIPTION LONGTEXT,
    SLUG VARCHAR(40) NOT NULL,
    SOURCE_LANGUAGE VARCHAR(255),
    ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_7DB9ECCC_FAEF_4161_BFB2_85A4C4BE96BF) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_7DB9ECCC_FAEF_4161_BFB2_85A4C4BE96BF,
    CREATIONDATE TIMESTAMP NOT NULL,
    LASTCHANGED TIMESTAMP NOT NULL,
    VERSIONNUM INT NOT NULL
);   
ALTER TABLE PUBLIC.TRANSMEMORY ADD CONSTRAINT PUBLIC.CONSTRAINT_14 PRIMARY KEY(ID);            
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TRANSMEMORY;              
CREATE CACHED TABLE PUBLIC.TRANSMEMORYUNIT(
    TRANS_UNIT_ID LONGTEXT,
    SOURCE_LANGUAGE VARCHAR(255),
    TM_ID BIGINT NOT NULL,
    UNIQUE_ID VARCHAR(255) NOT NULL,
    POSITION INT,
    ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_A46D148E_26EC_4ECC_80ED_A60EAB754F21) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A46D148E_26EC_4ECC_80ED_A60EAB754F21,
    CREATIONDATE TIMESTAMP NOT NULL,
    LASTCHANGED TIMESTAMP NOT NULL,
    VERSIONNUM INT NOT NULL
);          
ALTER TABLE PUBLIC.TRANSMEMORYUNIT ADD CONSTRAINT PUBLIC.CONSTRAINT_95 PRIMARY KEY(ID);        
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TRANSMEMORYUNIT;          
CREATE CACHED TABLE PUBLIC.TRANSMEMORYUNITVARIANT(
    LANGUAGE VARCHAR(255) NOT NULL,
    TRANS_UNIT_ID BIGINT NOT NULL,
    TAGGED_SEGMENT LONGTEXT NOT NULL,
    PLAIN_TEXT_SEGMENT LONGTEXT NOT NULL,
    PLAIN_TEXT_SEGMENT_HASH CHAR(32) NOT NULL,
    ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_EC9A15B9_9726_4429_84EA_52688B8B7F91) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_EC9A15B9_9726_4429_84EA_52688B8B7F91,
    CREATIONDATE TIMESTAMP NOT NULL,
    LASTCHANGED TIMESTAMP NOT NULL,
    VERSIONNUM INT NOT NULL
);             
ALTER TABLE PUBLIC.TRANSMEMORYUNITVARIANT ADD CONSTRAINT PUBLIC.CONSTRAINT_B3 PRIMARY KEY(ID); 
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TRANSMEMORYUNITVARIANT;   
CREATE CACHED TABLE PUBLIC.TRANSMEMORY_METADATA(
    TRANS_MEMORY_ID BIGINT NOT NULL,
    METADATA_KEY VARCHAR(75) NOT NULL,
    METADATA LONGTEXT
);          
ALTER TABLE PUBLIC.TRANSMEMORY_METADATA ADD CONSTRAINT PUBLIC.PK_TRANSMEMORY_METADATA PRIMARY KEY(TRANS_MEMORY_ID, METADATA_KEY);              
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TRANSMEMORY_METADATA;     
CREATE CACHED TABLE PUBLIC.TRANSMEMORYUNIT_METADATA(
    TM_TRANS_UNIT_ID BIGINT NOT NULL,
    METADATA_KEY VARCHAR(75) NOT NULL,
    METADATA LONGTEXT
);     
ALTER TABLE PUBLIC.TRANSMEMORYUNIT_METADATA ADD CONSTRAINT PUBLIC.PK_TRANSMEMORYUNIT_METADATA PRIMARY KEY(TM_TRANS_UNIT_ID, METADATA_KEY);     
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TRANSMEMORYUNIT_METADATA; 
CREATE CACHED TABLE PUBLIC.TRANSMEMORYUNITVARIANT_METADATA(
    TM_TRANS_UNIT_VARIANT_ID BIGINT NOT NULL,
    METADATA_KEY VARCHAR(75) NOT NULL,
    METADATA LONGTEXT
);      
ALTER TABLE PUBLIC.TRANSMEMORYUNITVARIANT_METADATA ADD CONSTRAINT PUBLIC.PK_TRANSMEMORYUNITVARIANT_METADATA PRIMARY KEY(TM_TRANS_UNIT_VARIANT_ID, METADATA_KEY);               
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TRANSMEMORYUNITVARIANT_METADATA;          
...
ALTER TABLE PUBLIC.TRANSMEMORY ADD CONSTRAINT PUBLIC.CONSTRAINT_148 UNIQUE(SLUG);              
...
ALTER TABLE PUBLIC.TRANSMEMORYUNIT_METADATA ADD CONSTRAINT PUBLIC.FK_METADATA_TMTRANSUNIT FOREIGN KEY(TM_TRANS_UNIT_ID) REFERENCES PUBLIC.TRANSMEMORYUNIT(ID) NOCHECK;         
...
ALTER TABLE PUBLIC.TRANSMEMORYUNITVARIANT ADD CONSTRAINT PUBLIC.FK_TRANSUNITVARIANT_TRANSUNIT FOREIGN KEY(TRANS_UNIT_ID) REFERENCES PUBLIC.TRANSMEMORYUNIT(ID) NOCHECK;        
...
ALTER TABLE PUBLIC.TRANSMEMORYUNITVARIANT_METADATA ADD CONSTRAINT PUBLIC.FK_METADATA_TRANSMEMORYUNITVARIANT FOREIGN KEY(TM_TRANS_UNIT_VARIANT_ID) REFERENCES PUBLIC.TRANSMEMORYUNITVARIANT(ID) NOCHECK;        
...
ALTER TABLE PUBLIC.TRANSMEMORYUNIT ADD CONSTRAINT PUBLIC.FK_TMUNIT_TRANS_MEMORY FOREIGN KEY(TM_ID) REFERENCES PUBLIC.TRANSMEMORY(ID) NOCHECK;  
...
ALTER TABLE PUBLIC.TRANSMEMORY_METADATA ADD CONSTRAINT PUBLIC.FK_METADATA_TRANSMEMORY FOREIGN KEY(TRANS_MEMORY_ID) REFERENCES PUBLIC.TRANSMEMORY(ID) NOCHECK;  
