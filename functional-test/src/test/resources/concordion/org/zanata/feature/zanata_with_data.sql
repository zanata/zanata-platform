...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_50231309_6061_4BBE_BCF4_FBFA62B5395A START WITH 4 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_2859F01D_3D5A_4B75_B09B_1EA847883279 START WITH 4 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_79179848_56F7_4E3D_B30B_97780C5EF1D9 START WITH 1 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_3A887215_E661_446A_A33C_53135877FA1D START WITH 1 BELONGS_TO_TABLE;     
...
CREATE CACHED TABLE PUBLIC.HRAWDOCUMENT(
    ...
    ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_BA183351_98A7_4661_8F21_67F11853E409) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_BA183351_98A7_4661_8F21_67F11853E409,
    CREATIONDATE TIMESTAMP NOT NULL,
    LASTCHANGED TIMESTAMP NOT NULL,
    VERSIONNUM INT NOT NULL,
...
-- 5 +/- SELECT COUNT(*) FROM PUBLIC.HACCOUNTMEMBERSHIP;       
...
-- 3 +/- SELECT COUNT(*) FROM PUBLIC.HPERSON;  
INSERT INTO PUBLIC.HPERSON(ID, CREATIONDATE, LASTCHANGED, VERSIONNUM, EMAIL, NAME, ACCOUNTID) VALUES
(1, TIMESTAMP '2012-04-03 15:06:28.0', TIMESTAMP '2012-04-03 15:06:28.0', 0, 'pahuang@redhat.com', 'Administrator', 1),
(2, TIMESTAMP '2012-04-03 15:06:28.0', TIMESTAMP '2012-04-03 15:06:28.0', 0, 'translator@redhat.com', 'translator', 2),
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.HPOTARGETHEADER;          
...
-- 3 +/- SELECT COUNT(*) FROM PUBLIC.HACCOUNT; 
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.HTEXTFLOWTARGET;          
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.HACCOUNTACTIVATIONKEY;    
