...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_50231309_6061_4BBE_BCF4_FBFA62B5395A START WITH 3 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_2859F01D_3D5A_4B75_B09B_1EA847883279 START WITH 3 BELONGS_TO_TABLE;     
...
-- 4 +/- SELECT COUNT(*) FROM PUBLIC.HACCOUNTMEMBERSHIP;       
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.HPERSON;  
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.HACCOUNT; 
