...
public class RegisterTest {
    ...
    public void rejectIncorrectCaptcha() {
        ...
        RegisterPage registerPage =
                homePage.goToRegistration().setFields(fields).registerFailure();
        assertThat("The Captcha entry is rejected", registerPage.getErrors(),
    ...
    public void passwordsMatch() {
        ...
        RegisterPage registerPage =
                homePage.goToRegistration().setFields(fields);
        assertThat("Passwords fail to match error is shown",
                registerPage.getErrors(), Matchers.contains(errorMsg));
    }
