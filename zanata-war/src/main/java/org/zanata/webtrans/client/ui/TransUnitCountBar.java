...
public class TransUnitCountBar extends Composite implements
        HasTranslationStats, HasMouseOverHandlers, HasMouseOutHandlers,
        HasClickHandlers {
    ...
    @UiField
    FlowPanel approvedPanel, draftPanel, untranslatedPanel, undefinedPanel,
            translatedPanel;
    ...
    private void setupLayoutPanel(double undefinedLeft, double undefinedWidth,
        ...
        layoutPanel.setWidgetLeftWidth(untranslatedPanel, untranslatedLeft,
                Unit.PX, untranslatedWidth, Unit.PX);
    }
    ...
    private void setLabelText() {
        ...
        case PERCENT_COMPLETE:
            if (statsByWords) {
                ...
                label.setText(TextFormatUtil
                        .formatPercentage(wordTranslatedProportion) + "%");
            } else {
                double messageTranslatedProportion =
                        stats.getStats(localeId.getId(), StatUnit.MESSAGE)
                                .getPercentTranslated();
                label.setText(TextFormatUtil
                        .formatPercentage(messageTranslatedProportion) + "%");
            }
            break;
        default:
