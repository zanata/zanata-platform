...
public class SideMenuPresenter extends WidgetPresenter<SideMenuPresenter.Display>
{
   ...
   {
      HasClickHandlers getSideMenuButton();
   ...
   protected void onBind()
   {
      ...
      registerHandler(eventBus.addHandler(WorkspaceContextUpdateEvent.getType(), new WorkspaceContextUpdateEventHandler()
      {
         ...
         public void onWorkspaceContextUpdated(WorkspaceContextUpdateEvent event)
         {
            ...
            display.getSideMenuTab().setVisible(!userWorkspaceContext.hasReadOnlyAccess());
      ...
      display.getSideMenuButton().addClickHandler(new ClickHandler()
      {
         @Override
