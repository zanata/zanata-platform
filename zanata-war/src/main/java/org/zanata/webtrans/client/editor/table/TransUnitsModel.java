...
public class TransUnitsModel implements EditRowCallback
{
   ...
   public TransUnitSelectionStatus moveToIndex(int rowIndex)
   {
      if (rowIndex < 0 || rowIndex >= transUnits.size())
      {
         return TransUnitSelectionStatus.INVALID_SELECTION;
      }
      boolean moved = rowIndex != currentIndex;
      currentIndex = rowIndex;
      return moved ? TransUnitSelectionStatus.MOVED : TransUnitSelectionStatus.SELECTED;
   }
