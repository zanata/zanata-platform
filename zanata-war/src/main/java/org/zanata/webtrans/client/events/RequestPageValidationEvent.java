 ...
 * 
 */
public class RequestPageValidationEvent extends GwtEvent<RequestPageValidationHandler>
{
   /**
    * Handler type.
    */
   public static Type<RequestPageValidationHandler> TYPE = new Type<RequestPageValidationHandler>();
