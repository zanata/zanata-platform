...
public class DocumentListTable extends FlexTable
{
   ...
   private Widget getStatsWidget(DocumentInfo docInfo, boolean statsByWords)
   {
      ...
      final TransUnitCountBar graph = new TransUnitCountBar(messages, LabelFormat.PERCENT_COMPLETE, false, userWorkspaceContext.getWorkspaceRestrictions().isProjectRequireReview());
