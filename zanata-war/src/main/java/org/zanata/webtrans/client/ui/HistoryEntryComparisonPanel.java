...
public class HistoryEntryComparisonPanel extends Composite {
    private static ComparisonPanelUiBinder ourUiBinder = GWT
            .create(ComparisonPanelUiBinder.class);
    ...
    interface ComparisonPanelUiBinder extends
            UiBinder<ScrollPanel, HistoryEntryComparisonPanel> {
    }
