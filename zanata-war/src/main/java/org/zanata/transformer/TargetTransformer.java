...
{
   private final TargetCommentTransformer targetCommentTransformer = new TargetCommentTransformer();
   ...
   public boolean transform(TextFlowTarget from, HTextFlowTarget to)
   {
      ...
      changed |= transferFromTextFlowTargetExtensions(from.getExtensions(true), to);
      return changed;
   }

   private boolean transferFromTextFlowTargetExtensions(ExtensionSet<TextFlowTargetExtension> extensions, HTextFlowTarget hTarget)
   {
      boolean changed = false;
