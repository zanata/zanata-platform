 ...
 */
public class PatchedCaptchaResponseValidator implements
        ConstraintValidator<PatchedCaptchaResponse, String> {
    private static final String WRAPPED_MESSAGE_TEMPLATE_IDENTIFIER =
            "{org.jboss.seam.captcha.error}";
    ...
    private void addConstraintViolationIn(ConstraintValidatorContext context) {
        ...
        context.buildConstraintViolationWithTemplate(
                WRAPPED_MESSAGE_TEMPLATE_IDENTIFIER).addConstraintViolation();
    }
}
