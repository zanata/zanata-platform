...
public class EhcacheWrapper<K, V> implements CacheWrapper<K, V> {
    ...
    public static <K, V> EhcacheWrapper<K, V> create(final String cacheName,
            final CacheManager cacheManager) {
    ...
    public static <K, V> EhcacheWrapper<K, V> create(final String cacheName,
            final CacheManager cacheManager, CacheLoader<K, V> loader) {
        EhcacheWrapper<K, V> cacheWrapper = create(cacheName, cacheManager);
        cacheWrapper.getCache().registerCacheLoader(
                new EhcacheLoader<K, V>(loader));
        return cacheWrapper;
    }
