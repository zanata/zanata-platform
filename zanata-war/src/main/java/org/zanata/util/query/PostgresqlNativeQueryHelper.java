 ...
 */
public class PostgresqlNativeQueryHelper implements NativeQueryHelper {
    ...
    public String convertTz(String value, String systemOffset,
            String userOffset) {
        return "(" + value + " AT TIME ZONE '" + systemOffset
                + "') AT TIME ZONE '" + userOffset + "'";
    }

    @Override
    public String date(String value) {
        return "date_trunc('day', " + value + ")";
    }
}
