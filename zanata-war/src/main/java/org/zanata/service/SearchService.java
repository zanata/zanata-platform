...
{
   /**
    * Requests the start of a system reindex.
    * NOTE: This is not a stable, supported API. It might change from release to release.
    *
    * @param purgeAll Purges all indexes.
    * @param indexAll Reindexes all elements.
    * @param optimizeAll Optimizes all indexes.
   ...
   /**
    * Returns the status of a system search reindex operation.
    * NOTE: This is not a stable, supported API. It might change from release to release.
    *
    * @return The following response status codes will be returned from this operation:<br>
    * OK(200) - Response containing the Indexing process' status if one is in progress.<br>
    * NOT FOUND(404) - If there is no indexing task currently in progress.<br>
    * INTERNAL SERVER ERROR(500) - If there is an unexpected error in the server while performing this operation.
    */
   @GET
   @Path("/reindex")
