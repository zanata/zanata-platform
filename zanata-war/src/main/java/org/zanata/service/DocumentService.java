...
public interface DocumentService
{
    ...
    *             finished.
    * @param handle A process handle to keep track of any progress.
    * @return The created / updated document
    * @see DocumentService#saveDocument(String, String, org.zanata.rest.dto.resource.Resource, java.util.Set, boolean, ProcessHandle)
    */
   public HDocument saveDocument( String projectSlug, String iterationSlug, Resource sourceDoc,
                                  Set<String> extensions, boolean copyTrans, boolean lock, ProcessHandle handle );
    ...
    */
   public HDocument saveDocument( String projectSlug, String iterationSlug, Resource sourceDoc,
                                  Set<String> extensions, boolean copyTrans, ProcessHandle handle );
