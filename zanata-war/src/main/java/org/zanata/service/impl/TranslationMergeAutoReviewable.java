 ...
 */
class TranslationMergeAutoReviewable implements TranslationMergeService
{
   private TextFlowTargetHistoryDAO textFlowTargetHistoryDAO;

   public TranslationMergeAutoReviewable(TextFlowTargetHistoryDAO textFlowTargetHistoryDAO)
   {
