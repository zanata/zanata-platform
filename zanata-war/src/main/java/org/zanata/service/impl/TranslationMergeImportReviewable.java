 ...
 */
class TranslationMergeImportReviewable implements TranslationMergeService
{
   private TextFlowTargetHistoryDAO textFlowTargetHistoryDAO;

   public TranslationMergeImportReviewable(TextFlowTargetHistoryDAO textFlowTargetHistoryDAO)
   {
