...
public class SmartEntitySecurityListener extends EntitySecurityListener
{
   ...
   private static boolean isEntityRestricted( Object entity, EntityAction action )
   {
      EntityRestrict entityRestrict = entity.getClass().getAnnotation(EntityRestrict.class);
