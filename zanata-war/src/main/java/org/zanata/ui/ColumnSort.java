...
/**
 * Handles column sorting in a page.
 * Used in conjuction with the richext:columnSorter custom composite tag to recreate automatic
 * sorting in rich:dataTable components.
 *
...
public class ColumnSort
{
   ...
   private Map<String, SortOrder> sortingOrder = new HashMap<String, SortOrder>();
   ...
   public void cycleSorting(ColumnSortCompositeComponent columnSort)
   {
      ...
      if( currentSort == null || currentSort == SortOrder.unsorted || currentSort == SortOrder.descending )
      {
