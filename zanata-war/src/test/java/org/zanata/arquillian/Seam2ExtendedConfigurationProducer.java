 ...
 *
 * This is an extended listener on the Arquillian Suite Extension to make it work with Arquillian Seam2 extension
 * 1.0.0.Alpha2. Once 1.0.0.Final is released, this class should not be needed and it should stop compiling.
 *
