...
public class TestTransformer implements IAnnotationTransformer {
    ...
    public void transform(ITestAnnotation annotation, Class testClass,
        ...
        if (testClass != null) {
            ...
            fixGroups(annotation, testConstructor.getDeclaringClass(),
                    testConstructor);
    ...
    private void fixGroups(ITestAnnotation annotation, Class testClass,
            Object subject) {
    ...
    private void ensureSeamGroup(ITestAnnotation annotation, Object subject) {
        ...
        List<String> groups =
                new ArrayList<String>(Arrays.asList(annotation.getGroups()));
    ...
    private void checkUnitTestGroup(ITestAnnotation annotation, Object subject) {
        ...
        if (groups.size() == 0) {
            if (WARN_ABOUT_MISSING_GROUP) {
                System.err.printf(
                        "assuming group '%s' for '%s' (no groups specified)\n",
                        rightGroup, subject);
            }
