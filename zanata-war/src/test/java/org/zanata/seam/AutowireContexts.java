...
public class AutowireContexts
{
   ...
   private final Map<ContextType, Map<String, Object>> allContexts = new HashMap<ContextType, Map<String, Object>>();
   ...
   /**
    * Searches for a value in all available contexts. It will search in lower scoped contexts first
    * and then move above (as Seam does).
    *
   ...
   public void putValue( String name, ContextType ctx, Object value )
   {
      ...
      if( context == null )
      {
         throw new RuntimeException("Context of Type " + ctx.name() + " is not available. Check the SeamAutowire setup.");
      }
      else
      {
