...
public class DummyGetDownloadAllFilesProgressCommand implements Command
{
   ...
   public DummyGetDownloadAllFilesProgressCommand(GetDownloadAllFilesProgress gwcAction, AsyncCallback<GetDownloadAllFilesProgressResult> gwcCallback)
   {
   ...
   public void execute()
   {
      ...
      callback.onSuccess(new GetDownloadAllFilesProgressResult(100, 100, "dummyId"));
