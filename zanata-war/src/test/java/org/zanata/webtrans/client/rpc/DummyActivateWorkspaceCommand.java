...
public class DummyActivateWorkspaceCommand implements Command
{
   ...
   public void execute()
   {
      ...
      userWorkspaceContext.setSelectedDoc(new DocumentInfo(new DocumentId(1), "Dummy doc", "Dummy path", LocaleId.EN_US, null, "Translator", new Date(), new HashMap<String, String>()));
