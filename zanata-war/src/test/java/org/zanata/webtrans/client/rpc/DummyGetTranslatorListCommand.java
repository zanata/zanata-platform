...
public class DummyGetTranslatorListCommand implements Command
{
   ...
   public void execute()
   {
      ...
      HashMap<SessionId, PersonSessionDetails> translator = new HashMap<SessionId, PersonSessionDetails>();
      translator.put(new SessionId("dummySession"), new PersonSessionDetails(new Person(new PersonId("personID"), "Some Person with an Incredibly Long Name", "http://www.gravatar.com/avatar/longname@zanata.org?d=mm&s=16"), null));
