...
public class TextFlowDAOTest extends ZanataDbunitJpaTest {
    ...
    public void canBuildAcceptAllQuery() {
        String contentStateCondition =
                TextFlowDAO.buildContentStateCondition(ContentStateGroup
    ...
    public void canBuildNewOnlyConditional() {
        ContentStateGroup contentStates =
                ContentStateGroup.builder().removeAll().includeNew(true)
                        .build();
        String contentStateCondition =
                TextFlowDAO.buildContentStateCondition(contentStates, "tft");
    ...
    public void canBuildSearchQuery() {
        // no search term
        assertThat(TextFlowDAO.buildSearchCondition(null, "tft"),
                Matchers.equalTo("1"));
        assertThat(TextFlowDAO.buildSearchCondition("", "tft"),
                Matchers.equalTo("1"));

        // with search term
        assertThat(
                TextFlowDAO.buildSearchCondition("a", "tft"),
