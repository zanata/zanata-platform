...
public class RemoteTestSignalerImpl implements RemoteTestSignaler
{
   ...
   private void invokeAnnotatedMethods(Object o, Class<? extends Annotation> annotation)
         throws InvocationTargetException, IllegalAccessException
   {
      ...
      while( objClass != null )
      {
         beforeMethods.addAll(ReflectionHelper.getMethodsWithAnnotation(objClass, annotation));
