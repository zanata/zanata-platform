...
public class TranslationsRawCompatibilityITCase extends RestTest
{
   ...
   public void putJsonResourceMeta() throws Exception
   {
      ...
      new ResourceRequest(getRestEndpointUrl("/projects/p/sample-project/iterations/i/1.0/r/my,path,document-2.txt"), "PUT",
   ...
   public void putJsonTranslations() throws Exception
   {
      ...
      new ResourceRequest(getRestEndpointUrl("/projects/p/sample-project/iterations/i/1.0/r/my,path,document-2.txt/translations/" + LocaleId.EN_US), "PUT",
            getAuthorizedEnvironment())
      {
         @Override
         protected void prepareRequest(ClientRequest request)
