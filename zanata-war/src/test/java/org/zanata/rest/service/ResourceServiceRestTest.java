...
public class ResourceServiceRestTest extends ResourceTranslationServiceRestTest {
    private final Logger log = LoggerFactory
            .getLogger(ResourceServiceRestTest.class);
    ...
    public void testPutGetResourceWithExtension(Resource sr) {
        ...
        sourceDocResource.putResource(sr.getName(), sr, new StringSet(
                "gettext;comment"));
        Resource get =
                sourceDocResource.getResource(sr.getName(),
    ...
    public void testPutNoExtensionGetResource(Resource sr) {
        ...
        sourceDocResource.putResource(sr.getName(), sr, new StringSet(
                "gettext;comment"));
        Resource get =
                sourceDocResource.getResource(sr.getName(), null).getEntity();
        Resource base = resourceTestFactory.getTextFlowTest();
        ResourceTestUtil.clearRevs(base);
        ResourceTestUtil.clearRevs(get);
        log.debug("expect:" + base.toString());
    ...
    public Object[][] getResourceTestData() {
        return new Object[][] {
                new Object[] { resourceTestFactory.getPotEntryHeaderTest() },
                new Object[] { resourceTestFactory.getTextFlowCommentTest() },
