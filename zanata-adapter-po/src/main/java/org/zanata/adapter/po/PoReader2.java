...
// @formatter:on
    ...
    * 
    * If id is extracted from msgctxt, the value of msgctxt is cleared and
    * this method will throw an exception on subsequent calls with the same
    * message.
    * 
    * @param message
    * @param mapIdFromMsgctxt true to extract id from msgctxt and set msgctxt
    *                         to null, otherwise id is generated by hashing
    *                         msgctxt and msgid.
    * @return extracted or generated id.
    * 
    * @throws RuntimeException if called with mapIdFromMsgctxt=true but msgctxt
    *                          is null or empty.
    */
