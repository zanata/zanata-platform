...
public class SeamDispatch implements Dispatch
{
   ...
   private static class DefaultExecutionContext implements ExecutionContext
   {
      ...
      public <A extends Action<R>, R extends Result> R execute(A action, boolean allowRollback) throws ActionException
      {
      ...
      private <A extends Action<R>, R extends Result> void rollback(ActionResult<A, R> actionResult) throws ActionException
      {
   ...
   private <A extends Action<R>, R extends Result> ActionHandler<A, R> findHandler(A action) throws UnsupportedActionException
   {
      ...
      final ActionHandler<A, R> handler = (ActionHandler<A, R>) Component.getInstance(handlerClazz);
   ...
   private <A extends Action<R>, R extends Result> void doRollback(A action, R result, ExecutionContext ctx) throws ActionException
   {
      ActionHandler<A, R> handler = findHandler(action);
