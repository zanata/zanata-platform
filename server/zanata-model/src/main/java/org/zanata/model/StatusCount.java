...
public class StatusCount {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StatusCount)) return false;
        ...
        if (this$count == null ? other$count != null :
                !this$count.equals(other$count)) return false;
        return true;
    }
    ...
    public String toString() {
        return "org.zanata.model.StatusCount(status=" + this.getStatus() +
                ", count=" + this.getCount() + ")";
    }
}
