...
public class TMXUtilTest {
    ...
    public void extractPlainTextContent() throws Exception {
        assertThat(
                removeFormattingMarkup(
                        "<seg><bpt i=\"1\" x=\"1\">{\\b </bpt>Special<ept i=\"1\">}</ept> text</seg>"))
                .isEqualTo("Special text");
        assertThat(
    ...
    public void extractPlainTextContentWithNestedFootnote() throws Exception {
        ...
        assertThat(removeFormattingMarkup(segXML))
                .isEqualTo("Elephants are big.");
    }
}
