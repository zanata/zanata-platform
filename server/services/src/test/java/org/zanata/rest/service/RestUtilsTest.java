...
public class RestUtilsTest extends ZanataTest {
    ...
    public void getPoHeaderTest() throws Exception {
        testUnmarshallResource(getTestDocWithPoHeader());
    }

    @Test
    public void getPotEntryHeaderTest() throws Exception {
        testUnmarshallResource(getTestDocWithPotEntryHeader());
    }

    @Test
    public void getTextFlowCommentTest() throws Exception {
        testUnmarshallResource(getTestDocWithTextFlowComment());
    }

    @Test
    public void getTextFlowTest2() throws Exception {
        testUnmarshallResource(getTestDocWith2TextFlows());
    }

    @Test
    public void getResourceMeta() throws Exception {
        testUnmarshallResourceMeta(getTestDocMeta());
    }

    @Test
    public void getPoHeaderResourceMeta() throws Exception {
        testUnmarshallResourceMeta(getTestDocMetaWithPoHeader());
    }

    @Test
    public void getPoTargetHeaderTextFlowTargetTest()
            throws Exception {
        testUnmarshallTranslation(getTestPoTargetHeaderTextFlowTarget());
    }

    @Test
    public void getTestObject()
            throws Exception {
        testUnmarshallTranslation(getTestTranslationsResource());
    }

    @Test
    public void getTestObject2()
            throws Exception {
        testUnmarshallTranslation(getTestTranslationsResourceWith2Targets());
    }

    @Test
    public void getTextFlowTargetCommentTest()
            throws Exception {
        testUnmarshallTranslation(getTestTextFlowTargetComment());
    }
