...
storiesOf('List group', module)
    .add('default', () => (
        <span>
          <h2><img src="https://i.imgur.com/v4qLk4p.png" width="42px"/>List group</h2>
          <Well bsSize="large">List groups are a flexible and powerful component for displaying not only simple lists of elements, but complex ones with custom content.</Well>
       <ListGroup>
    ...
    .add('with links', () => (
        <span>
          <h2><img src="https://i.imgur.com/v4qLk4p.png"
                   width="42px"/>With links</h2>
          <Well bsSize="large">Set the <code>href</code> or <code>onClick</code> prop on <code>ListGroupItem</code>, to create a linked or clickable element.</Well>
        <ListGroup>
    ...
    .add('with headings', () => (
        <span>
          ...
          <Well bsSize="large">Set the <code>header</code> prop to create a structured item, with a heading and a body area.
        </Well>
          <ListGroup>
