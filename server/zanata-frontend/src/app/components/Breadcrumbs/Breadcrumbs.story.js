...
storiesOf('Breadcrumbs', module)
    .add('default', () => (
        <span>
        <h2><img src="https://i.imgur.com/v4qLk4p.png" width="42px" />Breadcrumbs</h2>
          <Well bsSize="large">Breadcrumbs are used to indicate the current page's location. All pages 2 levels deep or more should use breadcrumbs in frontend. ie. <code>topdir/breadcrumbshere/breadcrumbshere/</code></Well>
