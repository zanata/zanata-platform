...
interface Props {
  ...
  saving: boolean,
  settings: any,
  handleSaveSettings: (prevSettings: {}, newSettings: {}) => void,
  fetchServerSettings: () => void,
  form: any,
  router: any
}

class ServerSettings extends React.Component<Props, {}> {
  constructor(props) {
    super(props)
              ...
              <Card title='General'>
                <Form.Item  {...formItemLayout} label='Server URL'
                  ...
                  {getFieldDecorator('host.url', {
                    ...
                    <Input onChange={(e) => this.updateField('host.url', e)}
                ...
                <Form.Item {...formItemLayout} label='Register URL'
                  ...
                  {getFieldDecorator('register.url', {
                    ...
                    <Input
                      onChange={(e) => this.updateField('register.url', e)}
                ...
                <Form.Item {...formItemLayout} label='Email Domain Name'
                  ...
                  {getFieldDecorator('email.domain', {
                    ...
                    <Input
                      onChange={(e) => this.updateField('email.domain', e)}
                ...
                <Form.Item {...formItemLayout} label='Contact Admin Email'
                  ...
                  {getFieldDecorator('email.admin.addr', {
                    ...
                    <Input
                      onChange={(e) => this.updateField('email.admin.addr', e)}
                ...
                <Form.Item {...formItemLayout} label='From Email Address'
                  ...
                  {getFieldDecorator('email.from.addr', {
                    ...
                    <Input
                      onChange={(e) => this.updateField('email.from.addr', e)}
                ...
                <Form.Item {...formItemLayout} label='Terms of Use URL'
                  ...
                  {getFieldDecorator('terms.conditions.url', {
                    ...
                    <Input
                      onChange={(e) => this.updateField('terms.conditions.url', e)}
                ...
                <Form.Item {...formItemLayout} label='Help URL'
                  ...
                  {getFieldDecorator('help.url', {
                    ...
                    <Input onChange={(e) => this.updateField('help.url', e)}
                    ...
                    <Col span={20}>
                      <Form.Item extra={<span className='u-textWarning'>
                        ...
                        {getFieldDecorator('piwik.url', {
                          ...
                          <Input
                            onChange={(e) => this.updateField('piwik.url', e)}
                    ...
                    <Col span={4}>
                      <Form.Item>
                        {getFieldDecorator('piwik.idSite', {
                          ...
                          <Input
                            onChange={(e) => this.updateField('piwik.idSite', e)}
                ...
                <Card title='Server log' type='inner'>
                  <Form.Item {...tailFormItemLayout}
                    ...
                    {getFieldDecorator('log.email.active', {
                      ...
                      <Checkbox
                        onChange={(e) => this.updateCheckbox('log.email.active', e)}>
                        ...
                        <Form.Item>
                          {getFieldDecorator('log.email.level', {
                            ...
                            <Select placeholder='Log level'
                              ...
                              onChange={(e) => this.updateSelect('log.email.level', e)}>
                      ...
                      <Col span={20}>
                        <Form.Item>
                          {getFieldDecorator('log.destination.email', {
                            ...
                            <Input
                              onChange={(e) => this.updateField('log.destination.email', e)}
              ...
              <Card title='Security/Privacy'>
                <Form.Item {...formItemLayout} className='multi-rows-label'
                  ...
                  {getFieldDecorator('permitted.user.email.domain', {
                    ...
                    <Input
                      onChange={(e) => this.updateField('permitted.user.email.domain', e)}
                ...
                <Form.Item {...formItemLayout} label='Gravatar Rating'
                  ...
                  {getFieldDecorator('gravatar.rating', {
                    ...
                    <Select
                      onChange={(e) => this.updateSelect('gravatar.rating', e)}>
                      <Select.Option key='G'>
                        G Rating
                      </Select.Option>
                ...
                <Form.Item {...tailFormItemLayout}
                  ...
                  {getFieldDecorator('display.user.email', {
                    initialValue: this.state['display.user.email'].value
                      || this.state['display.user.email'].defaultValue
                  })(
                    <Checkbox
                      onChange={(e) => this.updateCheckbox('display.user.email', e)}>
                      Display user email
                    </Checkbox>
                  )}
                </Form.Item>
                ...
                <Form.Item {...tailFormItemLayout} extra={
                  ...
                  {getFieldDecorator('allow.anonymous.user', {
                    initialValue: this.state['allow.anonymous.user'].value
                      || this.state['allow.anonymous.user'].defaultValue
                  })(
                    <Checkbox
                      onChange={(e) => this.updateCheckbox('allow.anonymous.user', e)}>
                ...
                <Form.Item {...tailFormItemLayout}
                  ...
                  {getFieldDecorator('accept.translator.requests', {
                    initialValue: this.state['accept.translator.requests'].value
                      || this.state['accept.translator.requests'].defaultValue
                  })(
                    <Checkbox
                      onChange={(e) => this.updateCheckbox('accept.translator.requests', e)}>
              ...
              <Card title='Client'>
                <Card title='Max requests per API key' type='inner'>
                  <Form.Item {...formItemLayout}
                    ...
                    {getFieldDecorator('max.concurrent.req.per.apikey', {
                      ...
                      <InputNumber
                        placeholder={this.state['max.concurrent.req.per.apikey'].defaultValue}
                  ...
                  <Form.Item {...formItemLayout}
                    ...
                    {getFieldDecorator('max.active.req.per.apikey', {
                      ...
                      <InputNumber placeholder={this.state['max.active.req.per.apikey'].defaultValue}
                ...
                <Form.Item {...formItemLayout}
                  ...
                  {getFieldDecorator('fileupload.max.files.per.upload', {
                    ...
                    <InputNumber
                      placeholder={this.state['fileupload.max.files.per.upload'].defaultValue}
                ...
                <Form.Item {...formItemLayout} className='multi-rows-label'
                  ...
                  {getFieldDecorator('tm.fuzzy.bands', {
                    ...
                    <Input placeholder='e.g. 80 90'
                      onChange={(e) => this.updateField('tm.fuzzy.bands', e)}/>
                  )}
                </Form.Item>
              </Card>
              <br/>
  ...
  private updateField = (field, e) => {
    this.updateFormField(field, e.target.value)
  }

  private updateCheckbox = (field, e) => {
    this.updateFormField(field, e.target.checked)
  }

  private updateSelect = (field, val) => {
    this.updateFormField(field, val)
  }

  private updateFormField = (field, value) => {
...
function getPropertyValue(settings, key) {
  return {
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    handleSaveSettings: (prevSettings, newSettings) =>
