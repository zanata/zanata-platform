...
export const MT_MERGE_CANCEL_REQUEST = 'TM_MERGE_CANCEL_REQUEST'
export const MT_MERGE_CANCEL_SUCCESS = 'TM_MERGE_CANCEL_SUCCESS'
export const MT_MERGE_CANCEL_FAILURE = 'TM_MERGE_CANCEL_FAILURE'
