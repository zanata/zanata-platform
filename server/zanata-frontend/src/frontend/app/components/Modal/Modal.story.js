...
storiesOf('Modal', module)
  ...
  .add('default', () => (
      ...
      <Modal.Body>
        <h2><img src="https://react-bootstrap.github.io/assets/logo.png" width="42px" />Modals</h2>
        <Well>See the <a href="https://react-bootstrap.github.io/components.html#modals-props-modal">react-boostrap documentation on Modals</a> for props.</Well>
