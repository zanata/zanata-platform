 ...
 */
public class CleanDocumentStorageExtension implements BeforeEachCallback,
        AfterEachCallback {
    private static final org.slf4j.Logger log =
            org.slf4j.LoggerFactory.getLogger(CleanDocumentStorageExtension.class);
    ...
    public static void resetFileData() {
        ...
        if (path.exists()) {
            try {
                ...
                throw new RuntimeException("Error: Failed to delete " + path, e);
            }
        }
    }
