...
import org.zanata.util.FunctionalTestHelper.assumeFalse
...
class TranslateTextTest : ZanataTestCase() {
    ...
    private lateinit var zanataRestCaller: ZanataRestCaller
    ...
    fun before() {
        ...
        assumeFalse(
                "",
                File(CleanDocumentStorageRule.getDocumentStoragePath() +
                        "${File.separator}documents${File.separator}").exists())
