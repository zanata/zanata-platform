...
public class RegisterUsernameCharactersCTest extends ZanataTestCase {
    private static final org.slf4j.Logger log =
            org.slf4j.LoggerFactory.getLogger(RegisterUsernameCharactersCTest.class);

    public RegisterUsernameCharactersCTest(String testCharacter) {
        super();
    ...
    public static Collection<String> data() {
        ...
        for (int i = 32; i <= 126; i++) {
            ...
            if (!character.matches("[a-z]|[0-9]|_")) {
    ...
    public void usernameCharacters() {
        log.info("");
        RegisterPage registerPage = new BasicWorkFlow()
                .goToPage("account/register", RegisterPage.class)
                .enterUserName("test".concat(this.testCharacter));
        registerPage.defocus();
        registerPage.slightPause();
        assertThat(registerPage.getErrors()).contains(RegisterPage.USERNAME_VALIDATION_ERROR);
    }
