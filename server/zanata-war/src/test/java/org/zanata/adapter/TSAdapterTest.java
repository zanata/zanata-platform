...
public class TSAdapterTest {
    ...
    public void setup() {
        ...
        testFile = new File("src/test/resources/org/zanata/adapter/basicts.ts");
...
//        System.out.println(DTOUtil.toXML(resource));
        ...
        assertThat(resource.getTextFlows().get(1).getContents()).isEqualTo(
                ImmutableList.of("Line Two"));
        assertThat(resource.getTextFlows().get(2).getContents()).isEqualTo(
                ImmutableList.of("Line Three"));
