...
public class TSAdapterTest extends AbstractAdapterTest {
    ...
    public void testUploadedTranslationsFile() throws Exception {
        ...
        TranslationsResource translationsResource =
                getAdapter(TSAdapter.class).parseTranslationFile(rawDocument,
                        Optional.absent());
    ...
    public void testTranslatedTSDocument() throws Exception {
        ...
        getAdapter(TSAdapter.class).generateTranslatedFile(originalFile.toURI(), translations,
    ...
    public void testFailToParseTSTranslation() throws Exception {
        ...
        getAdapter(TSAdapter.class).parseTranslationFile(rawDocument, Optional.absent());
    }
    ...
    public void testFailToParseOriginalFile() throws Exception {
        ...
        getAdapter(TSAdapter.class).generateTranslatedFile(
