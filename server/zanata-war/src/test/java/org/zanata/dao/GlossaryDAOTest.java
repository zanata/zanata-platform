...
public class GlossaryDAOTest extends ZanataDbunitJpaTest {
    ...
    public void testGetTermByLocaleId() {
        ...
        List<HGlossaryEntry> entryList = dao.getEntriesByLocale(
            LocaleId.EN_US, 0, 1, "", null, GlossaryUtil.GLOBAL_QUALIFIED_NAME);
    ...
    public void testGetTermByLocaleId2() {
        ...
        List<HGlossaryEntry> entryList = dao.getEntriesByLocale(
            LocaleId.EN_US, 0, 1, "", sortFields, GlossaryUtil.GLOBAL_QUALIFIED_NAME);
        assertThat(entryList.size(), is(1));
    }
    ...
    public void testGetTermEntryAndLocale() {
        ...
        HGlossaryTerm term =
                dao.getTermByEntryAndLocale(mockEntry.getId(), LocaleId.DE, GlossaryUtil.GLOBAL_QUALIFIED_NAME);
    ...
    public void testGetEntryBySrcContentLocale() {
        ...
        HGlossaryEntry entry = dao.getEntryByContentHash("hash", GlossaryUtil.GLOBAL_QUALIFIED_NAME);
        Assert.assertNotNull(entry);
