...
public class TransMemoryShortcutCopyEvent extends GwtEvent<TransMemoryShorcutCopyHandler>
{
   ...
   {
      return TYPE != null ? TYPE : (TYPE = new Type<TransMemoryShorcutCopyHandler>());
   }
