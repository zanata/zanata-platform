...
public class ValidationService
{
   ...
   public ValidationService(final EventBus eventBus, final TableEditorMessages messages, final ValidationMessages valMessages)
   {
      ...
      eventBus.addHandler(RunValidationEvent.getType(), new RunValidationEventHandler()
      {
         ...
         {
            execute(event.getSource(), event.getTarget(), event.isFireNotification());
         }
      });
   ...
   public void execute(String source, String target, boolean fireNotification)
   {
      ...
      fireValidationWarningsEvent(errors, fireNotification);
   }
   ...
   public void fireValidationWarningsEvent(List<String> errors, boolean fireNotification)
   {
      if (!errors.isEmpty() && fireNotification)
      {
         eventBus.fireEvent(new NotificationEvent(Severity.Info, messages.notifyValidationError()));
      }
      eventBus.fireEvent(new UpdateValidationWarningsEvent(errors));
   }
}
