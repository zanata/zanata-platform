...
public class EditorColumnTableDefinition extends DefaultTableDefinition<TransUnit> {
    ...
    public EditorColumnTableDefinition(final NavigationMessages messages, final RedirectingCachedTableModel<TransUnit> tableModel, final EventBus eventBus, boolean isReadOnly) {
