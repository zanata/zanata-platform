...
public final class DocumentUploadedEvent {
    ...
    public DocumentUploadedEvent(long actorId, Long documentId,
            boolean isSourceDocument, LocaleId localeId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DocumentUploadedEvent)) return false;
        ...
        if (this$documentId == null ? other$documentId != null :
                !this$documentId.equals(other$documentId)) return false;
        if (this.isSourceDocument() != other.isSourceDocument()) return false;
    ...
    public String toString() {
        return "org.zanata.events.DocumentUploadedEvent(actorId=" +
                this.getActorId() + ", documentId=" + this.getDocumentId() +
                ", isSourceDocument=" + this.isSourceDocument() +
