...
public class LeftLanguageTeam {
    ...
    public LeftLanguageTeam(String username, LocaleId localeId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LeftLanguageTeam)) return false;
    ...
    public String toString() {
        return "org.zanata.events.LeftLanguageTeam(username=" +
