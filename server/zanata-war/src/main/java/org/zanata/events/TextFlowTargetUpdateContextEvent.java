...
public class TextFlowTargetUpdateContextEvent {
    ...
    public TextFlowTargetUpdateContextEvent(TransUnitId transUnitId,
            LocaleId localeId, EditorClientId editorClientId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TextFlowTargetUpdateContextEvent)) return false;
        ...
        if (this$editorClientId == null ? other$editorClientId != null :
                !this$editorClientId.equals(other$editorClientId)) return false;
        ...
        if (this$updateType == null ? other$updateType != null :
                !this$updateType.equals(other$updateType)) return false;
        return true;
    }
    ...
    public String toString() {
        return "org.zanata.events.TextFlowTargetUpdateContextEvent(transUnitId=" +
