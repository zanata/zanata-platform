...
public class TranslationMatrix {
    ...
    public TranslationMatrix(String savedDate, String projectSlug,
            String projectName, String versionSlug, LocaleId localeId,
            String localeDisplayName, ContentState savedState, long wordCount) {
    ...
    public void setSavedState(ContentState savedState) {
        this.savedState = savedState;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TranslationMatrix)) return false;
        ...
        if (this$savedDate == null ? other$savedDate != null :
                !this$savedDate.equals(other$savedDate)) return false;
        ...
        if (this$projectName == null ? other$projectName != null :
                !this$projectName.equals(other$projectName)) return false;
        ...
        if (this$savedState == null ? other$savedState != null :
                !this$savedState.equals(other$savedState)) return false;
    ...
    public String toString() {
        return "org.zanata.rest.dto.TranslationMatrix(savedDate=" +
                this.getSavedDate() + ", projectSlug=" + this.getProjectSlug() +
                ", projectName=" + this.getProjectName() + ", versionSlug=" +
