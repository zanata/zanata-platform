...
public class FileService implements FileResource {
     ...
     */
    static class POStreamingOutput implements StreamingOutput {
    ...
    static class POTStreamingOutput implements StreamingOutput {
        private Resource resource;
    ...
    static class InputStreamStreamingOutput implements StreamingOutput {
        ...
        public void write(OutputStream output) throws IOException,
            ...
            log.debug("Copied {} bytes to output", copied);
        }
    }
