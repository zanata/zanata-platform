...
public class ProjectMaintainerChangedEvent extends WebhookEventType {
    ...
    @java.beans.ConstructorProperties({ "project", "username", "role",
            "changeType" })
    public ProjectMaintainerChangedEvent(String project, String username,
            ProjectRole role,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProjectMaintainerChangedEvent)) return false;
        ...
        if (this$role == null ? other$role != null :
                !this$role.equals(other$role)) return false;
