 ...
 */
public class GetStatisticsOptionsImpl extends ConfigurableProjectOptionsImpl
    ...
    @Option(
            name = "--details",
            usage = "Include statistics for lower levels (i.e., for documents in a project version)."
    ...
    @Option(
            name = "--word",
            usage = "Include word level statistics. By default only message level statistics are shown.")
    public
    ...
    @Override
    @Option(name = "--docid", metaVar = "DOCID",
            usage = "Document Id to fetch statistics for.")
