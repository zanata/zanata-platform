...
public abstract class BasicOptionsImpl implements BasicOptions {
    ...
    @Override
    @Option(name = "--errors", aliases = { "-e" },
            usage = "Output full execution error messages (stacktraces)")
    ...
    @Option(name = "--quiet", aliases = { "-q" },
            usage = "Quiet mode - error messages only")
    ...
    @Option(name = "--batch-mode", aliases = "-B",
            usage = "Run in non-interactive (batch) mode")
