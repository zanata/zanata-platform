 ...
 */
package org.zanata.client.console;
...
public class GetStatisticsConsoleCmd implements Command, GetStatisticsOptions
{
   @Option private boolean includeDetails;
   @Option private boolean includeWordLevelStats;
   @Option private String format;
   @Option private String documentId;
   @Option private String project;
   @Option private File projectConfig;
   @Option private String projectVersion;
   ...
   @Option private boolean disableSSLCert;
   @Option private Boolean debug = null;
   @Option(name = "errors", shortName = 'X') private Boolean errors = null;
   @Option private boolean help;
   @Option private Boolean quiet = null;
   @Option private boolean interactiveMode;
