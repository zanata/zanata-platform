...
Both [Zanata CLI](http://docs.zanata.org/en/latest/client/#installation) and [Zanata Maven plugin](http://docs.zanata.org/en/latest/client/maven-plugin/installation/) uses it.
...
For more information on setting up Zanata client, see [Zanata Client configuration](http://docs.zanata.org/en/latest/client/configuration/).