...
Notice the presence of the `zanta.xml` file already there. This file will be generated for you by the [Zanata client init](http://docs.zanata.org/en/latest/client/commands/init/) command, or you can download it from the Zanata server. This file will look something like this:
