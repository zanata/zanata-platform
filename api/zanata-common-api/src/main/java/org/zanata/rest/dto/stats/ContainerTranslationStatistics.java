...
public class ContainerTranslationStatistics implements Serializable {
    ...
    public void setDetailedStats(
            List<ContainerTranslationStatistics> detailedStats) {
    ...
    public void
            addDetailedStats(ContainerTranslationStatistics newDetailedStats) {
        if (this.detailedStats == null) {
            this.detailedStats =
                    new ArrayList<ContainerTranslationStatistics>();
        }
     ...
     *         cannot be found.
     */
    public TranslationStatistics getStats(String localeId,
    ...
    public String toString() {
        final StringBuilder sb =
                new StringBuilder("ContainerTranslationStatistics{");
