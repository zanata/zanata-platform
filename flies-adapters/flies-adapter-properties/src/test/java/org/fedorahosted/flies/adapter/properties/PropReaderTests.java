...
//		ProjectPackage.registerPartFactory(PotEntriesDataPart.FACTORY);
	...
	public void extractTemplateThenAddATarget() throws Exception {
		...
		for (String locale : locales){
			...
			PropReader.extractTarget(doc, new InputSource(testFRStream), new LocaleId(locale));
		}
		JAXBContext jc = JAXBContext.newInstance(Document.class.getPackage().getName());
//		JAXBContext jc = JAXBContext.newInstance(Document.class, TextFlowTargets.class);
