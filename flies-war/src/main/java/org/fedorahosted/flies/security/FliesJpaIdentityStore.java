...
public class FliesJpaIdentityStore extends JpaIdentityStore {
	...
	public static final String EVENT_NEW_USER_LOGGED_IN = "org.fedorahosted.flies.auth.new-user-logged-in" ;
	...
	private boolean nukesAuthenticate(String username, String password) {
		INukesAuthenticator authenticator = 
			(INukesAuthenticator) Component.getInstance("nukesSecurityService", ScopeType.STATELESS, true);
		try{
