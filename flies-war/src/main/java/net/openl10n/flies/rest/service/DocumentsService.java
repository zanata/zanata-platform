...
public class DocumentsService
{
   ...
   @POST
   @Consumes( { MediaTypes.APPLICATION_FLIES_DOCUMENTS_XML, MediaTypes.APPLICATION_FLIES_DOCUMENTS_JSON, MediaType.APPLICATION_JSON })
   @Admin
   ...
   public Response get()
   {
      ...
      URI iterationUri = baseUri.resolve(URIHelper.getIteration(projectSlug, iterationSlug));
