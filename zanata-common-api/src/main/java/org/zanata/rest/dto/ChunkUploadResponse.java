...
public class ChunkUploadResponse
{
   ...
   /**
    * Create a response indicating that something went wrong before starting an upload.
    * @param errorMessage detailing what went wrong
    */
   ...
   public ChunkUploadResponse(long uploadId, int accepted, boolean expectingMore, String successMessage)
   {
   ...
   {
      return "ChunkUploadResponse: uploadId=" + uploadId + " acceptedChunks=" + acceptedChunks
             + " expectingMore=" + expectingMore + " successMessage=\"" + successMessage
