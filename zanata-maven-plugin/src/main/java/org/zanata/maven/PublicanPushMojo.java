 ...
 * @see PushSimpleMojo
 */
public class PublicanPushMojo extends
        ConfigurableProjectMojo<PublicanPushOptions> implements
        PublicanPushOptions {
     ...
     * locale directories), although the location of "pot" can be overridden
     * with the srcDirPot option.
     *
    ...
    /**
     * Import/merge translations from local PO files to the server, overwriting
     * or erasing existing translations (DANGER!)
     *
    ...
    /**
     * Should the client validate XML before sending request to server
     * (debugging).
     *
