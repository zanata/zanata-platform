...
/**
 * Pulls translated text from Zanata. DEPRECATED: use 'pull' with projectType
 * 'podir' goal.
 *
 * @goal publican-pull
 * @requiresOnline true
 ...
 * @see PullSimpleMojo
 */
public class PublicanPullMojo extends
        ConfigurableProjectMojo<PublicanPullOptions> implements
        PublicanPullOptions {
