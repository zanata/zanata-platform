                  ...
                  <div className='left-form toolbar col-xs-12'>
                    ...
                    <div className='sort-items col-xs-6 col-sm-4 col-md-4
                      ...
                      <FormControl componentClass='select'
                        className='pull-right' id='ddlList1'>
                    ...
                    <table className='table'>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <a href=''>Afrikaans
                              <span className='greentext badge'>DEFAULT</span>
                            </a>
                            <br />
                          ...
                          <td>
                            <span><i className='fa fa-user'></i>0</span>
                          </td>
                          <td>
                            <Button bsSize='small'>
                        ...
                        <tr>
                          ...
                          <td>
                            <span><i className='fa fa-user'></i>2</span>
                          </td>
                          <td>
                            <Button bsSize='small'>
                              <i className='fa fa-times'></i>
                        ...
                        <tr>
                          ...
                          <td>
                            <span><i className='fa fa-user'></i>4</span>
                          </td>
                          <td>
                            <Button bsSize='small'>
                              <i className='fa fa-times'></i>
                        ...
                        <tr>
                          ...
                          <td>
                            <span><i className='fa fa-user'></i>1</span>
                          </td>
                          <td>
                            <Button bsSize='small'>
                              <i className='fa fa-times'></i>
                        ...
                        <tr>
                          ...
                          <td>
                            <span><i className='fa fa-user'></i>5</span>
                          </td>
                          <td>
                            <Button bsSize='small'>
                              <i className='fa fa-times'></i>
                        ...
                        <tr>
                          ...
                          <td>
                            <span><i className='fa fa-user'></i>8</span>
                          </td>
                          <td>
                            <Button bsSize='small'>
                              <i className='fa fa-times'></i>
