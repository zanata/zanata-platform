...
This command will:
 ...
 1. search for source documents in a directory specified as `src-dir` and any of its subdirectories (src-dir can be specified in zanata.xml or from command line option. Defailt is current directory).
